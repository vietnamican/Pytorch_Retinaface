...
if __name__ == '__main__':
    ...
    net_path = os.path.join('weights', 'mobilenet0.25_Final.pth')
    ...
    rgb_image_dir = os.path.join('data', 'eyestate_label', 'outputir', 'Open')
    out_open_image_dir = os.path.join('data', 'out', 'outputir', 'open_open')
    out_close_image_dir = os.path.join('data', 'out', 'outputir', 'open_close')
    if not os.path.isdir(out_open_image_dir):
        os.makedirs(out_open_image_dir)
    ...
    rgb_image_dir = os.path.join('data', 'eyestate_label', 'outputir', 'Close')
    out_open_image_dir = os.path.join('data', 'out', 'outputir', 'close_open')
    out_close_image_dir = os.path.join('data', 'out', 'outputir', 'close_close')
    if not os.path.isdir(out_open_image_dir):
        os.makedirs(out_open_image_dir)
    if not os.path.isdir(out_close_image_dir):
        os.makedirs(out_close_image_dir)
